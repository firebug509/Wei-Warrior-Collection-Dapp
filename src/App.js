  ...
  return (
    <s.Screen>
      <s.Container
        ...
        image={CONFIG.SHOW_BACKGROUND ? "/config/images/image0.png" : null} 
      >
      
       
          <StyledLogo alt={"logo"} src={"/config/images/title.png"} width="100%" />


        <s.SpacerSmall />
        <ResponsiveWrapper flex={1} style={{ padding: 44 }} test>
          
          <s.Container flex={1} jc={"top"} ai={"end"}>
          <img alt={"logo"} src={"/config/images/3.png"} width="150%"/>
          ...
          <s.Container
            ...
            ai={"center"}
            style={{
              backgroundColor: "var(--accent-new)",
              padding: 64,
              borderRadius: 14,
              border: "12px solid var(--secondary)",
              boxShadow: "0px 15px 11px 12px rgba(0,0,0,0.7)",
            }}
          >
            <s.TextTitle
              style={{
          ...
          <s.Container flex={1} jc={"end"} ai={"center"}>
            <StyledImg
              alt={"example"}
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          ...
          >
            ...
            Once you make the purchase, you cannot undo this action. During Whitelist mint Will fail anyone not Whitelisted
          ...
          >
            - The Minting of a Wei Warrior is an exclusive membership to an organic community, quality merch, and alot of surprizes -
          </s.TextDescription>
        </s.Container>
      </s.Container>
    </s.Screen>
